...
//#define NUS_BASE_UUID                  {{0x33, 0xFE, 0x67, 0xCB, 0xEB, 0x92, 0x19, 0xA9, 0xE7, 0x11, 0x3B, 0x96, 0x00, 0x00, 0x12, 0x04}} /**< Used vendor specific UUID. */
...
//将从串口接收到的数据发送给蓝牙,数据是以指针传入的，但是底层似乎会清空
